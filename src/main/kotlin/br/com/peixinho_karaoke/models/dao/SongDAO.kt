...
interface SongDAO {
    ...
    suspend fun addNewSong(title: String, artist: String, duration: Int, combined: String): Song?
    suspend fun addNewSongIgnore(title: String, artist: String, duration: Int, combined: String): Song?
